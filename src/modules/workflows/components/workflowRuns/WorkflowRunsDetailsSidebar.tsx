...
import { useWorkflowRunsContext } from './WorkflowRunsContext';
import { Sidebar } from '@/components/common/sidebar';
import { AccordionList } from '@/components/common/accordion';
import { SpinnerWithText } from '@/components/common/spinner';

const WorkflowRunsDetailsSidebar = () => {
  const { workflowRunDetail, isFetchingWorkflowRunDetail } = useWorkflowRunsContext();
    ...
    () =>
      workflowRunDetail
        ? {
            ...
            analysisRunContexts: workflowRunDetail?.analysisRun?.contexts.map((context) => [
              {
...
export default WorkflowRunsDetailsSidebar;
